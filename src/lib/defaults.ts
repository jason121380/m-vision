...
export const DEFAULT_CONFIG: AppConfig = {
  ...
  photographers: [
    { type: 'video', key: 'any', name: '不指定（輪班）', role: '', price: 0, photo: '', desc: '' },
    { type: 'video', key: 'le', name: '阿樂', role: '主理人', price: 3000, photo: '', desc: '' },
    { type: 'video', key: 'jb', name: '加冰', role: '動態平面老師', price: 1000, photo: '', desc: '' },
    { type: 'video', key: 'jarvis', name: 'JARVIS', role: '動態老師', price: 1000, photo: '', desc: '' },
    { type: 'photo', key: 'any', name: '不指定（輪班）', role: '', price: 0, photo: '', desc: '' },
    { type: 'photo', key: 'le', name: '阿樂', role: '主理人', price: 3000, photo: '', desc: '' },
    { type: 'photo', key: 'ryan', name: 'Ryan', role: '婚紗平面老師', price: 1000, photo: '', desc: '' },
    { type: 'photo', key: 'zhh', name: '智皓', role: '婚紗平面老師', price: 1000, photo: '', desc: '' },
  ],
  settings: {
